    ...
    <div>
      <section className="pl-[10rem] flex flex-wrap">
        <div className="mr-[4rem] mt-[5rem]">
          <h1 className="text-2xl font-semibold mb-4 ml-2">Iniciar sesión</h1>
        ...
        <img
          ...
          alt=""
          className="h-[37rem] w-[66%] xl:block md:hidden sm:hidden rounded-lg ml-2"
        /> 
      </section>
    </div>
  );
