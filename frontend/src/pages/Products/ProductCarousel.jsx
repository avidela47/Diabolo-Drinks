  ...
  return (
    <div className="mb-4 lg:block xl:block md:block">
      {isLoading ? null : error ? (
        ...
        <Slider
          {...settings}
          className="xl:w-[39rem] lg:w-[39rem] md:w-[50rem] sm:w-[30rem] sm:block"
        >
          {products.map(
            ({
              image,
              ...
              <div key={_id}>
                <img
                  src={image}
                  alt={name}
                  className="rounded-lg h-[20rem] w-[35rem] ml-[2rem]"
                />
                  ...
                  <div className="flex justify-between w-[20rem]">
                    <div className="one">
                      <h1 className="flex items-center mb-6">
                        <FaStore className="mr-2 text-white" /> Marca: {size}
                      </h1>
                      <h1 className="flex items-center mb-6">
                    ...
                    <div className="two">
                      <h1 className="flex items-center mb-6">
                        <FaStar className="mr-2 text-white" /> Calificación:{" "}
                        {Math.round(rating)}
                      </h1>
                      <h1 className="flex items-center mb-6">
